...
const Labor = createCheckbox("Labor");
options.appendChild(Labor);

const Barber = createCheckbox("Barber");
options.appendChild(Barber);

const Grocery = createCheckbox("Grocery");
options.appendChild(Grocery);

const Clinic = createCheckbox("Clinic");
options.appendChild(Grocery);
