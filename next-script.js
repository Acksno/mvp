...
const Cab = createCheckbox("Cab");
options.appendChild(Cab);

const Room = createCheckbox("Room");
options.appendChild(Room);

const Restroom = createCheckbox("Restroom");
options.appendChild(Restroom);
